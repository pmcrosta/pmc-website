...
scaled_pc_scores <- scale(pca_reduced)

## compute distance matrix
edge_d <- dist(scaled_pc_scores, method = "euclidean")

which(attr(edge_d, "Labels")=="Fair Haven Borough School District, NJ")

dim(as.matrix(edge_d))

# Find the indices of the closest districts
closest_indices <- order(as.matrix(edge_d)[, which(attr(edge_d, "Labels")=="Fair Haven Borough School District, NJ")])
...
# Apply k-means
kmeans_result <- kmeans(scaled_pc_scores, centers = 3)
